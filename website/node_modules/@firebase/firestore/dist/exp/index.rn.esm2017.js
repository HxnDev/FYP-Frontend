...
class Cu extends gu {
    ...
    constructor(t, e) {
         ...
         * Whether it's a Firestore or Firestore Lite instance.
         */
        this.type = "firestore", this._queue = new vu, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
